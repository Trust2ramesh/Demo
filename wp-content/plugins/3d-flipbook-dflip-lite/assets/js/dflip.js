...
utils.urlify = function (text) {
  ...
  while (result = myRegexp.exec(text)) {
    ...
    if ((url.match(/@/g) || []).length == 1) {
      //@ match has to be exactly 1, two occurances creates infinite loop in below regex https://github.com/deepak-ghimire/dearviewer/issues/524
      if (url.match(/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,7})+/gi)) {
        //cannot have $ end of string. take what matches https://github.com/deepak-ghimire/dearviewer/issues/546
        hits.push({
          index: result.index,
          length: url.length,
          text: url
...
defaults_DEARVIEWER.parseNormalElements = function () {
  ...
  utils_jQuery('.df-element').each(function () {
    ...
    if (isParsed !== "true") {
      ...
      if (element.data("df-editlink")) {
        element.append('<a class="df-edit-link" href="' + element.data("df-editlink") + '" >Edit Book</a>');
      }
    }
  });
...
var BaseFlipBookViewer = /*#__PURE__*/function (_BaseViewer) {
  ...
  flipbook_createClass(BaseFlipBookViewer, [{
    ...
    value: function handleZoom() {
      ...
      var maxZoom = this.maxZoom = app.dimensions.maxTextureSize / Math.max(leftDimen.height, leftDimen.width, rightDimen.height, rightDimen.width),
        zoomValue = app.zoomValue,
        zoomChanged = false,
        exitZoom = false,
        enterZoom = false;
    ...
    value: function getAnnotationElement(pageNumber) {
      var clean = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
      var isZoomViewer = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
      var annotationEl = undefined;
      if (this.app.zoomValue > 1 || isZoomViewer === true) annotationEl = this.zoomViewer.getAnnotationElement(pageNumber, clean);else annotationEl = flipbook_get(flipbook_getPrototypeOf(BaseFlipBookViewer.prototype), "getAnnotationElement", this).call(this, pageNumber, clean);
      if (annotationEl) {
    ...
    value: function getTextElement(pageNumber) {
      var clean = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
      var isZoomViewer = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
      if (this.app.zoomValue > 1 || isZoomViewer === true) return this.zoomViewer.getTextElement(pageNumber, clean);else return flipbook_get(flipbook_getPrototypeOf(BaseFlipBookViewer.prototype), "getTextElement", this).call(this, pageNumber, clean);
    }
  }, {
    key: "enterZoom",
...
var FlipBook3D = /*#__PURE__*/function (_BaseFlipBookViewer) {
  ...
  function FlipBook3D(options, appContext) {
    ...
    if (_this2.hasSpiral) {
      _this2.flexibility = 0;
    }
    if (_this2.flexibility == 0) options.sheetSegments = 8;
    ...
    _this2.texturePowerOfTwo = flipbook_3d_utils.isMobile ? false : (_options$texturePower = options.texturePowerOfTwo) !== null && _options$texturePower !== void 0 ? _options$texturePower : true;
  ...
  flipbook_3d_createClass(FlipBook3D, [{
    ...
    value: function initStage() {
      ...
      if (stage.spotLight.shadow) {
        stage.spotLight.shadow.bias = -0.005;
      }
...
var Page3D = /*#__PURE__*/function (_Page2D) {
  ...
  flipbook_3d_createClass(Page3D, [{
    ...
    value: function loadTexture(param) {
      ...
      var validGradient = flipbook_3d_DV.defaults.mockupMode === true && texture.nodeName === "CANVAS" && page.parent3D.viewer.flexibility !== 0 && !page.parent3D.isHard;
      if (this.face === 4) {
        if (validGradient) {
          var ctx = texture.getContext("2d");
          var centerColor = "rgb(127,127,255)";
          ctx.fillStyle = centerColor;
          var width = texture.width * page.parent3D.viewer.leftFlexibility;

          //left shade
          var grd = ctx.createLinearGradient(texture.width, 0, texture.width - width, 0);
          grd.addColorStop(0, "rgba(0,0,0,.2)");
          grd.addColorStop(0.05, "rgba(100,100,100,.1)");
          grd.addColorStop(.25, "rgba(100,100,100,.1)");
          grd.addColorStop(1, "rgba(200,200,200,0)");
          ctx.fillStyle = grd;
          ctx.beginPath();
          ctx.moveTo(texture.width - width, 0);
          ctx.lineTo(texture.width, 0);
          ctx.lineTo(texture.width, texture.height);
          ctx.lineTo(texture.width - width, texture.height);
          ctx.closePath();
          ctx.fill();
        }
        ...
        if (validGradient) {
          var _ctx = texture.getContext("2d");
          var _centerColor = "rgb(127,127,255)";
          _ctx.fillStyle = _centerColor;
          var _width = texture.width * page.parent3D.viewer.rightFlexibility / 2;

          //left shade
          var _grd = _ctx.createLinearGradient(0, 0, _width, 0);
          _grd.addColorStop(0, "rgba(0,0,0,.4)");
          _grd.addColorStop(0, "rgba(100,100,100,.1)");
          _grd.addColorStop(.25, "rgba(100,100,100,.1)");
          _grd.addColorStop(1, "rgba(200,200,200,0)");
          _ctx.fillStyle = _grd;
          _ctx.beginPath();
          _ctx.moveTo(0, 0);
          _ctx.lineTo(_width, 0);
          _ctx.lineTo(_width, texture.height);
          _ctx.lineTo(0, texture.height);
          _ctx.closePath();
          _ctx.fill();
        }
...
var HybridFlipbook3D = /*#__PURE__*/function (_FlipBook3D) {
  ...
  viewer_pros_createClass(HybridFlipbook3D, [{
    ...
    value: function getAnnotationElement(pageNumber) {
      var clean = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
      return viewer_pros_get(viewer_pros_getPrototypeOf(HybridFlipbook3D.prototype), "getAnnotationElement", this).call(this, pageNumber, clean, true);
    }
  }, {
    key: "getTextElement",
    value: function getTextElement(pageNumber) {
      var clean = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
      return viewer_pros_get(viewer_pros_getPrototypeOf(HybridFlipbook3D.prototype), "getTextElement", this).call(this, pageNumber, clean, true);
    }
  }, {
    key: "isAnimating",
    value: function isAnimating() {
    ...
    value: function loadDocument() {
      ...
      function pdfLoaded(pdf) {
        ...
        pdf.getPage(1).then(function (page) {
          ...
          app.dimensions.maxTextureHeight = ((_options$maxTextureSi = options.maxTextureSize) !== null && _options$maxTextureSi !== void 0 ? _options$maxTextureSi : 3200) / (!_isDefaultPageWide ? 1 : _defaultPageRatio);
...
var App = /*#__PURE__*/function () {
  function App(options) {
    ...
    options.maxTextureSize = (_options$maxTextureSi = options.maxTextureSize) !== null && _options$maxTextureSi !== void 0 ? _options$maxTextureSi : 2048;
    ...
    this.options.pixelRatio = app_utils.limitAt(this.options.pixelRatio, 1, 2);
    this.events = {};
        ...
        if (options.pdfVersion !== undefined) {
          ...
          if (options.pdfVersion == "latest" || options.pdfVersion == "default") {
            ...
            if (Array.prototype.at === undefined) {
              //Array.prototype.at was introduced at ES2022 which 3.7 requires
              pdfDir = "stable";
